...
try{window.Shiki={theme:"github-dark",setup(){this._shiki=io("https://Shiki.tecscimat.repl.co"),this._shiki.on("connect",()=>{console.log("ShikiHighlighter.js is ready for use!")}),this._shiki.on("shiki error",e=>{this.errorLog.push({time:(new Date).toString,error:e}),new Error(e)})},highlightAll(){document.querySelectorAll(".shiki-target").forEach(e=>{var t=e.dataset.theme||this.theme,i=e.dataset.language||"js",s=e.textContent||el.innerText;this.getHTMLCode(s,i,t).then(t=>{e.innerHTML=t.code})})},getHTMLCode(e,t,i=this.theme){var s=Math.random().toString(36).slice(2);return this._shiki.emit("shiki highlight",{code:e,language:t,theme:i,timestamp:s}),new Promise((e,t)=>{this._shiki.on("shiki highlight",t=>{t.timestamp==s&&e(t)})})},highlight(e){var t=e,i=t.textContent||t.innerText,s=t.dataset.language||"",a=t.dataset.theme||this.theme;this.getHTMLCode(i,s,a).then(e=>{t.innerHTML=e.code})},setTheme(e){this.theme=e},languages:["abap","actionscript-3","ada","apex","applescript","asm","asp-net-razor","awk","bat","c","clojure","cobol","coffee","cpp.embedded.macro","cpp","crystal","csharp","css","d","dart","diff","dockerfile","elixir","elm","erlang","fsharp","git-commit","git-rebase","gnuplot","go","graphql","groovy","hack","haml","handlebars","haskell","hcl","hlsl","html-ruby-erb","html","ini","java","javascript","js","jinja-html","json","jsonc","jsonnet","jsx","julia","kotlin","latex","less","lisp","logo","lua","makefile","markdown","matlab","mdx","nix","objective-c","ocaml","pascal","perl","perl6","php","pls","postcss","powershell","prolog","pug","puppet","purescript","python","r","razor","ruby","rust","sas","sass","scala","scheme","scss","shaderlab","shellscript","smalltalk","sql","ssh-config","stylus","swift","tcl","toml","ts","tsx","typescript","vb","viml","vue","wasm","xml","xsl","yaml","文言"],themes:["dark-plus","github-dark","github-light","light-plus","material-theme-darker","material-theme-default","material-theme-lighter","material-theme-ocean","material-theme-palenight","min-dark","min-light","monokai","nord","slack-theme-dark-mode","slack-theme-ochin","solarized-dark","solarized-light"],errorLog:[]},Shiki.setup()}catch(e){console.log("Your Browser Doesn't Support ShikiHighlighter.js"),new Error(e)}
